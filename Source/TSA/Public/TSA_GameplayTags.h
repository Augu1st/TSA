...
namespace CombatTags
{
	namespace Damage
	{
		UE_DECLARE_GAMEPLAY_TAG_EXTERN(PhysicalDamage);
		UE_DECLARE_GAMEPLAY_TAG_EXTERN(EnergyDamage);
		UE_DECLARE_GAMEPLAY_TAG_EXTERN(StructureDamage);
		
		UE_DECLARE_GAMEPLAY_TAG_EXTERN(Impact);// 冲击 累计眩晕值
		UE_DECLARE_GAMEPLAY_TAG_EXTERN(Cutting);// 切割 造成流血
		
		UE_DECLARE_GAMEPLAY_TAG_EXTERN(Electricity);// 电能 累计过载值
		UE_DECLARE_GAMEPLAY_TAG_EXTERN(Heat);// 热能 累计热量值
		
		UE_DECLARE_GAMEPLAY_TAG_EXTERN(Particle);// 粒子 直接造成生命值伤害
		UE_DECLARE_GAMEPLAY_TAG_EXTERN(Decompose);// 分解 按百分比降低抗性
	}
}
...
namespace InputTags
{
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Key_1);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Key_2);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Key_3);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Key_4);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Key_5);
	
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Key_Q);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Key_E);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Key_R);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Key_T);
	
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Key_Z);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Key_X);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Key_C);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Key_V);
}